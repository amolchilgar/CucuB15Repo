...
public class FacebookDataTableStepDefs {
	...
	public void setUp() throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Amol\\Desktop\\selenium09\\soft\\selenium-1\\chromedriver_win32_B39\\chromedriver.exe");
...
//		driver = new FirefoxDriver();
	...
	public void he_enters_following_data(DataTable table){
		//Initialize data table 
	      ...
	      driver.findElement(By.xpath("//input[@aria-label='First name']")).sendKeys(data.get(1).get(1));
	      driver.findElement(By.xpath("//input[@aria-label='Surname']")).sendKeys(data.get(2).get(1));

	      
	      
	      System.out.println(data.get(3).get(1));
	      
	      driver.findElement(By.xpath("//input[@aria-label='Mobile number or email address']")).sendKeys(data.get(3).get(1));
